...
def generate_land_use_areas_per_station():
    ...
    weather_stations = pd.read_csv('src/iFireTrackerModel/model/data/input/canterbury_weather_stations.csv') # coordinates of each station
    ...
    land_use_data = gpd.read_file('src/iFireTrackerModel/model/data/input/lucas-nz-land-use-map-1990-2008-2012-2016-v011.shx') # Can reduce row numbers using e.g. rows=1000
    ...
    merged_geometries.to_csv('src/iFireTrackerModel/model/data/input/merged/land_use_areas_per_station.csv', index=False)
